...
func TestService_createOrGetInstance(t *testing.T) {
	...
	tests := []struct {
		...
		{
			name: "instance does not exist (should create instance) with confidential compute disabled and any confidential instance type specified",
			scope: func() Scope {
				machineScope.GCPMachine = getFakeGCPMachine()
				hostMaintenancePolicyTerminate := infrav1.HostMaintenancePolicyTerminate
				machineScope.GCPMachine.Spec.OnHostMaintenance = &hostMaintenancePolicyTerminate
				confidentialInstTypeSEV := infrav1.ConfidentialVMTechSEV
		...
		{
			name: "instance does not exist (should create instance) with confidential compute enabled and any confidential instance type specified",
			scope: func() Scope {
				machineScope.GCPMachine = getFakeGCPMachine()
				hostMaintenancePolicyTerminate := infrav1.HostMaintenancePolicyTerminate
				machineScope.GCPMachine.Spec.OnHostMaintenance = &hostMaintenancePolicyTerminate
				confidentialInstTypeSEVSNP := infrav1.ConfidentialVMTechSEVSNP
