...
func TestService_createOrGetInstance(t *testing.T) {
	...
	tests := []struct {
		...
		{
			name: "instance does not exist (should create instance) with confidential compute disabled and SEV confidential instance type specified",
			scope: func() Scope {
				machineScope.GCPMachine = getFakeGCPMachine()
				hostMaintenancePolicyTerminate := infrav1.HostMaintenancePolicyTerminate
				machineScope.GCPMachine.Spec.OnHostMaintenance = &hostMaintenancePolicyTerminate
				confidentialInstTypeSEV := infrav1.ConfidentialVMTechnologySEV
				machineScope.GCPMachine.Spec.ConfidentialInstanceType = &confidentialInstTypeSEV
				return machineScope
			},
			mockInstance: &cloud.MockInstances{
				ProjectRouter: &cloud.SingleProjectRouter{ID: "proj-id"},
		...
		{
			name: "instance does not exist (should create instance) with confidential compute enabled and SEV-SNP confidential instance type specified",
			scope: func() Scope {
				machineScope.GCPMachine = getFakeGCPMachine()
				hostMaintenancePolicyTerminate := infrav1.HostMaintenancePolicyTerminate
				machineScope.GCPMachine.Spec.OnHostMaintenance = &hostMaintenancePolicyTerminate
				confidentialInstTypeSEVSNP := infrav1.ConfidentialVMTechnologySEVSNP
				machineScope.GCPMachine.Spec.ConfidentialInstanceType = &confidentialInstTypeSEVSNP
				confidentialComputePolicyEnabled := infrav1.ConfidentialComputePolicyEnabled
				machineScope.GCPMachine.Spec.ConfidentialCompute = &confidentialComputePolicyEnabled
				return machineScope
			},
		...
		},
		{
			...
			scope: func() Scope {
				...
				hostMaintenancePolicyTerminate := infrav1.HostMaintenancePolicyTerminate
				machineScope.GCPMachine.Spec.OnHostMaintenance = &hostMaintenancePolicyTerminate
				confidentialInstTypeTDX := infrav1.ConfidentialVMTechnologyTDX
				machineScope.GCPMachine.Spec.ConfidentialInstanceType = &confidentialInstTypeTDX
				confidentialComputePolicyEnabled := infrav1.ConfidentialComputePolicyEnabled
				machineScope.GCPMachine.Spec.ConfidentialCompute = &confidentialComputePolicyEnabled
				return machineScope
			},
