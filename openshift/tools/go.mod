...
require github.com/openshift/cluster-capi-operator/manifests-gen v0.0.0-20250513111004-39748f2db2d7
...
require (
	...
	github.com/cert-manager/cert-manager v1.14.7 // indirect
